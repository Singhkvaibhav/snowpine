...
INSERT INTO products (name, description, origin_country, category, price_inr, stock_quantity, image_url) VALUES
  ...
  ('Elodie Details Muslin Bib Set', 'Set of soft muslin bibs with Nordic prints.', 'Sweden', 'Baby Feeding', 4799.00, 15, NULL),
  ('Elodie Details Changing Pad Pouch', 'Portable changing pad that folds into a pouch.', 'Sweden', 'Baby Bedding', 6499.00, 15, NULL),
  ('Liewood Silicone Plate & Cup Set', 'Danish-designed silicone dinnerware for toddlers.', 'Denmark', 'Baby Feeding', 4599.00, 15, NULL),
  ('Liewood Wooden Pacifier Clip', 'Beechwood and silicone pacifier clip.', 'Denmark', 'Baby Feeding', 2999.00, 25, NULL),
  ('Filibabba Muslin Baby Blanket', 'Soft muslin swaddle blanket, GOTS-certified cotton.', 'Denmark', 'Baby Bedding', 5999.00, 15, NULL),
  ...
  ('Iittala Kastehelmi Bowl', 'Finnish glassware with a dewdrop pattern.', 'Finland', 'Tableware', 4399.00, 15, NULL),
  ('Iittala Taika Mug', 'Finnish porcelain mug with a forest-inspired print.', 'Finland', 'Tableware', 5099.00, 15, NULL),
  ('Marimekko Unikko Tote Bag', 'Finnish design house tote bag with the classic poppy print.', 'Finland', 'Bags', 6499.00, 15, NULL),
  ('Marimekko Unikko Cushion Cover', 'Cotton cushion cover with the iconic Unikko poppy print.', 'Finland', 'Home Decor', 7599.00, 15, NULL),
  ('Marimekko Oiva Mug', 'Minimalist Finnish stoneware mug.', 'Finland', 'Tableware', 3999.00, 15, NULL),
  ('Georg Jensen Stainless Steel Cutlery Set', 'Premium Danish cutlery set, 24-piece.', 'Denmark', 'Cutlery & Kitchenware', 41799.00, 10, NULL),
  ('Georg Jensen Bloom Candle Holder', 'Sculptural stainless steel candle holder.', 'Denmark', 'Home Decor', 10199.00, 10, NULL),
  ('Royal Copenhagen Mini Ornament', 'Fine porcelain ornament, hand-painted.', 'Denmark', 'Tableware', 6199.00, 15, NULL),
  ('Kay Bojesen Wooden Monkey Figurine', 'Iconic Danish design object, hand-turned teak.', 'Denmark', 'Home Decor', 18599.00, 10, NULL),
  ('HAY Kitchen Tea Towel Set', 'Danish design house kitchen textiles, set of two.', 'Denmark', 'Textiles', 3999.00, 15, NULL),
  ('Muuto Small Candle Holder', 'Minimalist Scandinavian candle holder.', 'Denmark', 'Home Decor', 7599.00, 15, NULL),
  ('Skagerak Wooden Serving Board', 'FSC-certified oak serving board, Danish design.', 'Denmark', 'Cutlery & Kitchenware', 9499.00, 10, NULL),
  ...
  ('Arabia Moomin Mug - Moominmamma', 'Official Arabia porcelain mug featuring Moominmamma.', 'Finland', 'Tableware', 4699.00, 15, NULL),
